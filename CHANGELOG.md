...
## [2.7.0](https://github.com/Mourdi59/MD_OCERP/compare/v2.6.11...v2.7.0) (2026-05-29)


### Features

* /login dark-mode contrast + Reporting renderer UI + dashboard widget schemas ([3189dae](https://github.com/Mourdi59/MD_OCERP/commit/3189daec0f3649a3072df6f0eb7c2cc37542aafc))
* 10-wave audit fixes + 6 new partner packs ([f13d443](https://github.com/Mourdi59/MD_OCERP/commit/f13d443e44a8e656c57af0df5c475bb57fd23b03))
* **accommodation:** group detail tabs into 3 blocks, rebuild Charges UX ([80fc140](https://github.com/Mourdi59/MD_OCERP/commit/80fc14049c1535f3d6d8bc156c8b12be0827607a))
* **accommodation:** i18n keys + critical-flow tests for the UX overhaul ([a3f1dde](https://github.com/Mourdi59/MD_OCERP/commit/a3f1dde86ad235552fd8e4dc6e86f7ba046db18c))
* **accommodation:** polish list page — summary KPIs, EmptyState, RecoveryCard ([876f1ed](https://github.com/Mourdi59/MD_OCERP/commit/876f1ed43845e8678b1b910e041901a47237f118))
* **approval-routes:** backend engine — routes, instances, step-states (alembic v3147) ([c2a9d02](https://github.com/Mourdi59/MD_OCERP/commit/c2a9d0235f7e889bbb405ef1ee1348923735b539))
* **approval-routes:** frontend engine — admin page + instance card + markups integration ([5ad57d6](https://github.com/Mourdi59/MD_OCERP/commit/5ad57d61b786443894404854caead9c7f443be8b))
* **audit-api:** timeline endpoint + GDPR redact-actor (Epic H §H7/H9) ([e0714fa](https://github.com/Mourdi59/MD_OCERP/commit/e0714fa9a1d3132a25a48d117cf8367958b9d36c))
* **audit:** ActorContextMiddleware + audit_context_dep (Epic H §H1/H2) ([50f387a](https://github.com/Mourdi59/MD_OCERP/commit/50f387a05e1362898921ca533ec2c3fad48fe7a8))
* **audit:** extend oe_activity_log with 8 capture-context columns (Epic H §H3/H6) ([e02b71f](https://github.com/Mourdi59/MD_OCERP/commit/e02b71f7f4eabe93f7a491bd8c61a045058eab4a))
* **audit:** mirror oe_core_audit_log writes into oe_activity_log (Epic H §H6 shim) ([9802309](https://github.com/Mourdi59/MD_OCERP/commit/9802309d4479614a394ba344339405e2ac635818))
* **audit:** prune_audit_pii task scrubs IP+UA past retention window (Epic H §H8) ([78c7f5b](https://github.com/Mourdi59/MD_OCERP/commit/78c7f5b870c848f75d50a78b3c9075a8a54a132b))
* **bim/smart-views:** canonical-format rule engine + property catalog + preview endpoint ([3e126cc](https://github.com/Mourdi59/MD_OCERP/commit/3e126ccff7428d00d1e5ffbd5fdd76973cd4e402))
* **bim/smart-views:** visual rule builder + live count preview ([a830bae](https://github.com/Mourdi59/MD_OCERP/commit/a830baeeafc5d0435d79ceba4f6f2231c68e02f4))
* **bim:** surface silent Parquet-write failures + retry endpoint ([#155](https://github.com/Mourdi59/MD_OCERP/issues/155)) ([92e4e34](https://github.com/Mourdi59/MD_OCERP/commit/92e4e3439f6d6c7a5e104f684ba8feaf218064ef))
* **bim:** viewer Quality Mode (Fast/Default/Visual/Walk) + toolbar reorder ([adf884b](https://github.com/Mourdi59/MD_OCERP/commit/adf884b79b61916f4124e11376b2dfab6ddf755b))
* **boq:** add /import/auto/ dispatcher + Deprecation headers on legacy import routes ([c535529](https://github.com/Mourdi59/MD_OCERP/commit/c535529230aa7a7610429cd580f30c2f0d210931))
* **boq:** add FIEBDC-3 / BC3 native importer for Spain + LATAM ([373feb2](https://github.com/Mourdi59/MD_OCERP/commit/373feb2abebe7d1cca1d30224cf99917d2a4aaea))
* **boq:** introduce importers package with Protocol + encoding helpers ([fabab68](https://github.com/Mourdi59/MD_OCERP/commit/fabab68956943b1baa3d47b821db973c6605fe7c))
* **boq:** move Excel/CSV import into importers/excel.py with NRM + MasterFormat heuristics ([0a11e99](https://github.com/Mourdi59/MD_OCERP/commit/0a11e99e3d1839636d6f487da07671f2d9bda85e))
* **boq:** move GAEB XML parsing into importers/gaeb_xml.py ([bae771a](https://github.com/Mourdi59/MD_OCERP/commit/bae771a5b86879f35de0c736f217692d7a9474cd))
* **boq:** R7 deep-improve — assemblies / takeoff / carbon ([cee8236](https://github.com/Mourdi59/MD_OCERP/commit/cee8236be084d14da7bae66b5ac68347fc626af2))
* **brazil:** Tier-1 BR invoice support — BRL + NBR 12721 + RPS-layout PDF ([6f0cd81](https://github.com/Mourdi59/MD_OCERP/commit/6f0cd817fce1baeadbea6e6153c4e5be9f25e578))
* **catalog:** show full resource name in expanded detail panel ([7949468](https://github.com/Mourdi59/MD_OCERP/commit/7949468bc953fa8e2c9ad1325c3bdc2ca0748720))
* **contracts:** lifecycle pipeline + expiry badge + clone + template chips + multi-currency rollup ([3b2017d](https://github.com/Mourdi59/MD_OCERP/commit/3b2017d76e000b43cdb09732429c400190ccd94f))
* **converters:** one-click DWG install on /dwg-takeoff + simpler BIM "out of date" copy ([6dfd554](https://github.com/Mourdi59/MD_OCERP/commit/6dfd5544278e2b00c0c1beb41cefe9c8aafc05b2))
* **dashboard:** consolidate 9 wave-2 widgets into one Operations snapshot card ([600e7da](https://github.com/Mourdi59/MD_OCERP/commit/600e7da357f163b467d9a5a33894ca0c75e3a5e6))
* **documents:** wire uploads + revisions into unified version chain ([ae710bc](https://github.com/Mourdi59/MD_OCERP/commit/ae710bce44ecbda8697072ebda2061d48e3c7504))
* **eac:** R7 deep-improve — IDOR-404 + magic-byte uploads + Decimal-str + tenant-scoped service ([47c2e6b](https://github.com/Mourdi59/MD_OCERP/commit/47c2e6b651da3193c3da23079b94cb38a22fad01))
* emit approval-routes lifecycle events for consumer fan-out ([38ad833](https://github.com/Mourdi59/MD_OCERP/commit/38ad833de5b447da3e890ff8c5b19aad7a72c38a))
* **field:** design doc + role/skeleton for mobile field-worker surface ([6c65871](https://github.com/Mourdi59/MD_OCERP/commit/6c658716508db1beecfd6b10f8e146caef15a85d))
* **field:** Field-worker Daily Diary MVP with PIN-gated magic-link auth (Epic F [#113](https://github.com/Mourdi59/MD_OCERP/issues/113)) ([406f4f3](https://github.com/Mourdi59/MD_OCERP/commit/406f4f35c6c078520478a0e5c41477af16c0e1b4))
* **file-versions:** RevisionsPanel + StaleVersionPill + revision upload (Epic C) ([04d49bb](https://github.com/Mourdi59/MD_OCERP/commit/04d49bbb1010524be8c9133c7c2e0edcf4a1f391))
* **file-versions:** unify version chain across comments + markups (Epic C) ([aa5d6ad](https://github.com/Mourdi59/MD_OCERP/commit/aa5d6adb24a0704ed6766060cf54993b1c6fd886))
* **files:** file_favorites endpoints + tests (per-user star/pin) ([4fac034](https://github.com/Mourdi59/MD_OCERP/commit/4fac0340b76f60ed7daf553fa6e226a1b75f1e73))
* **files:** star/pin UI on /files + favourites filter (frontend + migration) ([1e02fac](https://github.com/Mourdi59/MD_OCERP/commit/1e02face49fee92da496586a631c4f7113dbd42a))
* **formwork:** MVP module — systems catalogue + BOQ assignments + reuse-aware unit cost ([fdb299b](https://github.com/Mourdi59/MD_OCERP/commit/fdb299bed104bdc4fe0b006548eb49df3f40eb04))
* **geo_hub:** address autocomplete + clustering + error states + coord UX + cache admin + drift indicator ([5414f73](https://github.com/Mourdi59/MD_OCERP/commit/5414f73949e25a2e617f96902a78acdaaa11e668))
* **geo_hub:** auto-geocode + auto-anchor from project address (Nominatim w/ 30d cache) ([42113a1](https://github.com/Mourdi59/MD_OCERP/commit/42113a11030b88c9072cd8538ad4ba14403002e5))
* **geo-hub:** 2D / 3D / Columbus scene-mode toggle with persistence ([3a822c0](https://github.com/Mourdi59/MD_OCERP/commit/3a822c03e3dfdb64d9f73fd3007e690e65b46899))
* **geo-hub:** auto-zoom camera to fit overlays + 3D tiles on load ([fefd10e](https://github.com/Mourdi59/MD_OCERP/commit/fefd10e607685773e4c80188bdae77220aea14f5))
* **geo-hub:** left sidebar listing overlays + tilesets with fly-to ([1a42657](https://github.com/Mourdi59/MD_OCERP/commit/1a42657fe431f5d3a8877f2d7d789ec2bcc30082))
* **geo-hub:** per-overlay visibility + opacity controls ([56c6efd](https://github.com/Mourdi59/MD_OCERP/commit/56c6efd7e4e9dd23047a82444fd70c5f3494a457))
* **geo-hub:** round 2 deep audit — close storage leaks + tighten validation ([8f7f144](https://github.com/Mourdi59/MD_OCERP/commit/8f7f14497491691d73e27a79485177adeb012287))
* **geo+projects:** one-click 2D/3D toggle + always-on project map ([eb7c611](https://github.com/Mourdi59/MD_OCERP/commit/eb7c611f0445e9bc64526589e79ed07c5bd920b8))
* **geo:** alembic v3145 — backfill addresses on pre-v3.2.0 demo projects ([6336057](https://github.com/Mourdi59/MD_OCERP/commit/6336057745d4d69cda17759c1e253eee1d0e3208))
* **geo:** collapsible Open Data license pill on /geo viewer ([0eb3ab0](https://github.com/Mourdi59/MD_OCERP/commit/0eb3ab0f0a79550745460e18a83f313ff07e8e63))
* **geo:** instant address-search overlay with fly-to + dismissible pin ([5f11a15](https://github.com/Mourdi59/MD_OCERP/commit/5f11a15e497da9884a3d8305d255012a6864eee2))
* **geo:** Photon (Komoot) as primary geocoder, Nominatim as fallback ([67212c5](https://github.com/Mourdi59/MD_OCERP/commit/67212c54c74b0abce525bb449a0edaba08bc93f9))
* **hse:** UX polish + improvements ([65cf017](https://github.com/Mourdi59/MD_OCERP/commit/65cf0170e0cb70ed2c87baa301ae5ce6c1084838))
* **i18n:** backfill 31 LoginPage keys to 14 locales ([005f792](https://github.com/Mourdi59/MD_OCERP/commit/005f792e0cdabce65bed0c964d95fc0ef6ad996e))
* **i18n:** backfill v4.9.0 keys to 26 locales (EN placeholder) ([c70fff4](https://github.com/Mourdi59/MD_OCERP/commit/c70fff47988755bff3d478b8dd9f0a97eaf2fdda))
* **i18n:** cs+hr+pl+ro coverage to ≥70% (high-traffic surfaces) ([d5419dd](https://github.com/Mourdi59/MD_OCERP/commit/d5419dde5a9b75d146948338e60070dc0e2f3d74))
* **i18n:** da+no+sv coverage to ≥70% (high-traffic surfaces) ([600a98d](https://github.com/Mourdi59/MD_OCERP/commit/600a98dd403ad1a63c4ae48e0a03b2cad171c375))
* **i18n:** fi coverage to &gt;=70% (high-traffic surfaces) ([1dad0a3](https://github.com/Mourdi59/MD_OCERP/commit/1dad0a39150237576ab89af4a2d31e92eda7b377))
* **i18n:** fill missing ai.* keys in en.ts (Quick Estimate) ([75bb45c](https://github.com/Mourdi59/MD_OCERP/commit/75bb45ca0221216549a76ce579499f0b5e3ecead))
* **i18n:** ko coverage to ≥75% (high-traffic surfaces) ([94d24f8](https://github.com/Mourdi59/MD_OCERP/commit/94d24f8736f2b54299ac32b924205faed0f594b1))
* **i18n:** translate 1197 JA keys (high-traffic surfaces) ([2c9dfbc](https://github.com/Mourdi59/MD_OCERP/commit/2c9dfbc7b09cb056f941fae2b7d64aeafc1398e6))
* **i18n:** zh coverage to &gt;=75% (high-traffic surfaces) ([b892e0c](https://github.com/Mourdi59/MD_OCERP/commit/b892e0c6c6559872a20069ab338363a2d9ba37b0))
* **marketing-news:** inject related-articles widget on 15 article pages ([6e95750](https://github.com/Mourdi59/MD_OCERP/commit/6e95750bff48c5dc1dbe96866abe412c11f2fb44))
* **marketing:** add 3 workshop attendee testimonials to DDC section ([22a26b3](https://github.com/Mourdi59/MD_OCERP/commit/22a26b366ad1caaa3d3edf10f262d0e52328e392))
* **marketing:** move workshop testimonials + bigger client logos ([396ad34](https://github.com/Mourdi59/MD_OCERP/commit/396ad342abe5059f2b1d1a56296310bc45e1542a))
* **marketing:** related-articles widget pattern + asset ([d0b7919](https://github.com/Mourdi59/MD_OCERP/commit/d0b7919f5c4396f64ce64fb8d97559ef624021e9))
* **markups:** add assignee_id + filter + UI chip (alembic v3146) ([2dfc440](https://github.com/Mourdi59/MD_OCERP/commit/2dfc440c0d5942dce29725b9635b46abbef68aed))
* **markups:** back-to-document deep-link with scroll + pulse highlight ([eb03b58](https://github.com/Mourdi59/MD_OCERP/commit/eb03b58331889cfc772f69dc63224ff23f802b1e))
* **markups:** EditMarkupModal for title/description/color ([8e751bc](https://github.com/Mourdi59/MD_OCERP/commit/8e751bc3f6b2f59e534637e3d1ac4dbf62a348b2))
* **markups:** prev/next chevron nav + keyboard shortcuts ([2b87900](https://github.com/Mourdi59/MD_OCERP/commit/2b87900c598faae3fde5defda9edcdf76818b3f1))
* **markups:** re-assign the markup owner from the edit modal ([1237ce7](https://github.com/Mourdi59/MD_OCERP/commit/1237ce7a051ecab951f7375aa15d92ee300d7235))
* **modules:** Management-of-Change + Progress modules ([3815570](https://github.com/Mourdi59/MD_OCERP/commit/3815570d5ed96b4b3b11d042300ffcab36237a69))
* **modules:** R7 deep-improve sweep — variations/changeorders/clash/coordination/dms/finance/procurement/punchlist/service/submittals/rfi ([ea79a7c](https://github.com/Mourdi59/MD_OCERP/commit/ea79a7c6dc4bd9823472aafc2be520dd0e78428f))
* **modules:** surface partner packs on /modules and discover repo packs ([6296162](https://github.com/Mourdi59/MD_OCERP/commit/6296162408d85fecbfd1855c4d1c4e8acccd654f))
* **modules:** wire log_activity into 11 modules' transition methods (Epic H §H4) ([1c70c68](https://github.com/Mourdi59/MD_OCERP/commit/1c70c68fcfe6a2cc679ce2b756f898ae180ef85d))
* **notifications:** Epic B core — real dispatcher, WS hub, worker, webhook targets ([9db0f79](https://github.com/Mourdi59/MD_OCERP/commit/9db0f7937e27055b3b9107b4c2fbf2232f30668f))
* **notifications:** Epic B frontend — WS push hook, webhook admin UI, white-screen regression test ([6b833fc](https://github.com/Mourdi59/MD_OCERP/commit/6b833fc9ed7de202334d492bbae15fa9f2bedb69))
* **partner-pack:** pip-installable preset bundles for white-label partners ([32e7966](https://github.com/Mourdi59/MD_OCERP/commit/32e7966c38b088bac68fd3484c2b71d9c854fdad))
* **polish-wave:** deep-improve /geo, /takeoff, /resources, /dwg-takeoff, BIM Smart Views ([51eb894](https://github.com/Mourdi59/MD_OCERP/commit/51eb894a4e95224f93c51be8296575dcb6673596))
* **procurement:** PO status pipeline + delivery countdown + mobile Issue button ([8eee37a](https://github.com/Mourdi59/MD_OCERP/commit/8eee37ac751cff3fc72574c88c13caf8f03e9463))
* **projects:** customizer + 7 new widgets on project detail page ([d92048a](https://github.com/Mourdi59/MD_OCERP/commit/d92048aa3aaa826fe6c68a198cb0a4a98b9b218d))
* **propdev:** group tabs into Master data / Sales / Operations blocks ([8f4234c](https://github.com/Mourdi59/MD_OCERP/commit/8f4234c8db84d59d7329961042104f469fa01dc2))
* **property_dev:** 5 sales-analytics endpoints + widgets (cohort retention, time-to-close, lead source, funnel, broker leaderboard) ([3e79d2a](https://github.com/Mourdi59/MD_OCERP/commit/3e79d2a78a33fb587e19977e877260bf1ff2d43b))
* **property_dev:** add 6 new built-in document templates (tenant_lease, move_in_checklist, mortgage_clearance, title_deed_transfer, escrow_release, refund_authorization) ([22735f9](https://github.com/Mourdi59/MD_OCERP/commit/22735f906f0d26cfd54bb0a9be92e2f7574d8cf1))
* **property_dev:** bulk operations admin — plot status / reservation expiry / docs regen / lead CSV / buyer merge ([44c040a](https://github.com/Mourdi59/MD_OCERP/commit/44c040aa2e76f9559571648c05109a4eb5c1376a))
* **property_dev:** buyer portal mobile-first polish + KYC drag-and-drop + payment schedule timeline + magic-link landing ([fbde07d](https://github.com/Mourdi59/MD_OCERP/commit/fbde07dcbb9eba203227bc2b961f705f24469422))
* **property_dev:** buyer portal verify is single-use (industry standard) ([664a34a](https://github.com/Mourdi59/MD_OCERP/commit/664a34af7bb01ad11d0d1c4f9decc7be5e86e8f9))
* **property_dev:** buyer self-service portal (magic-link auth + payment schedule + docs + KYC upload) ([92323b1](https://github.com/Mourdi59/MD_OCERP/commit/92323b1492edaa66e35226ccee3b976d923d5f64))
* **property_dev:** in-browser editor for custom HTML/MD templates with variable picker + live preview ([8ef0f9c](https://github.com/Mourdi59/MD_OCERP/commit/8ef0f9c554b612603c75e34e08ab820827990b2f))
* **property_dev:** inventory map — block/floor/unit grid + bulk hold/release + KPI ribbon ([ee4d667](https://github.com/Mourdi59/MD_OCERP/commit/ee4d667ab88b6b1a56f705eb38189012f8c5b13d))
* **property_dev:** pricing engine — price lists + rules + snapshot on reservation (alembic v3124_propdev_pricing_engine) ([debbb0e](https://github.com/Mourdi59/MD_OCERP/commit/debbb0e233c8e188a934661c6deb062aa9015dcf))
* **property_dev:** pricing engine UI — list editor + rule editor + simulator + quote history ([85a02aa](https://github.com/Mourdi59/MD_OCERP/commit/85a02aadd70309ad602b0368f1c0add7583f5aed))
* **property_dev:** pricing engine UX polish — conflict resolution + time picker + currency select + simulator compare + history filters + snapshot indicator ([22fbaa6](https://github.com/Mourdi59/MD_OCERP/commit/22fbaa6c24e1292b320ea30253638739310aba90))
* **property_dev:** worldwide-parameterize doc-template settings ([bbb2ba9](https://github.com/Mourdi59/MD_OCERP/commit/bbb2ba9da693c02b5f9e6236166f7397c1a5ebd0))
* **property-dev:** doc templates expand SUPPORTED_LOCALES from 6 to 27 (matches frontend catalogue, untranslated fall back to EN) ([945b033](https://github.com/Mourdi59/MD_OCERP/commit/945b033aa266e48b169cc05f15f73d9d8bc0086f))
* **property-dev:** document-template locales — native names + tenant overrides ([d5065ca](https://github.com/Mourdi59/MD_OCERP/commit/d5065ca5a196b50caaa4990dfc79c99386dfdb5e))
* **qa:** Playwright e2e infrastructure — fixtures + helpers + 10 smoke specs + parallel runner ([3a6df2e](https://github.com/Mourdi59/MD_OCERP/commit/3a6df2ee1a56946eae453ce2ae79469a7195e974))
* **qms:** R7 deep-improve — QMSAuditLog model + audit-log infrastructure ([32791e3](https://github.com/Mourdi59/MD_OCERP/commit/32791e3b04eccf49a934f2692327014d9121a13c))
* **regional-exchange:** polymorphic page + 20-country registry (Wave 5 Epic I — I13/I14) ([401512c](https://github.com/Mourdi59/MD_OCERP/commit/401512c96a60efcd44f1d72e316a39271c82b076))
* **regional-exchange:** ship sample import files (Wave 5 Epic I — I15) ([752254e](https://github.com/Mourdi59/MD_OCERP/commit/752254e43036e6821adfc579893e749d4f5b5983))
* **reporting:** UX polish + history panel + HTML-escape hardening ([f13004e](https://github.com/Mourdi59/MD_OCERP/commit/f13004e1b118f16818536046862a548fb7a71b06))
* **requirements:** real DIN276/NRM/MasterFormat gate-4 compliance check ([c14184f](https://github.com/Mourdi59/MD_OCERP/commit/c14184fe403698f0bd62f459903f8554778fbb61))
* **resources:** inline editing + add/delete + clearer empty states ([a800bc2](https://github.com/Mourdi59/MD_OCERP/commit/a800bc258309949a4f973e232e6aa6941081ca55))
* **rfi:** UX polish + ball-in-court + linked-position + response thread ([8a3c667](https://github.com/Mourdi59/MD_OCERP/commit/8a3c667458930d1905de3ca25e1a276f67ee026c))
* **schedule:** critical-path + baseline-variance + mobile fallback ([d400c85](https://github.com/Mourdi59/MD_OCERP/commit/d400c850ed6d4174802c28f70369fd1efdc6acd3))
* **settings,geo:** converters tab + full-bleed geo pages ([f3434e0](https://github.com/Mourdi59/MD_OCERP/commit/f3434e0454d036f9b4bf5fe0959ef69039181351))
* **settings:** embed BIM-style health banner on Converters tab ([571f683](https://github.com/Mourdi59/MD_OCERP/commit/571f683c93c5caca5e7b0319b50a58bbeb80cea4))
* **sidebar:** add Integrations as 8th admin-grid item ([7c1cfe1](https://github.com/Mourdi59/MD_OCERP/commit/7c1cfe19a70f9a494a83f87712e0d2b8406e3825))
* **sidebar:** drop duplicate Integrations tile + order admin grid by importance ([524d644](https://github.com/Mourdi59/MD_OCERP/commit/524d644aff6e92b526c0cb6fe5c72601074db606))
* **sidebar:** group Approval Routes and Validation Rules under Approvals & Rules ([6cae3f1](https://github.com/Mourdi59/MD_OCERP/commit/6cae3f119850a47de092a5b713b16467bf76d1fe))
* **sidebar:** inline Approval Routes + Validation Rules after Roles, drop the section label ([90f349a](https://github.com/Mourdi59/MD_OCERP/commit/90f349a2acbf36b80dd39bfb445e3a5f968bb6d2))
* **subcontractors:** scorecard + insurance expiry + lien upload ([933412e](https://github.com/Mourdi59/MD_OCERP/commit/933412e59a3602d95db6ecfaef3dc06c78e88cea))
* **submittals:** UX polish + status pipeline + overdue indicator ([bf4d425](https://github.com/Mourdi59/MD_OCERP/commit/bf4d425b7cc6ee7c38f1d3e2cc0c95a6c7cd295b))
* **system:** one-click in-app upgrade ([cedd93c](https://github.com/Mourdi59/MD_OCERP/commit/cedd93c060bf1939417996c33a8646a44e435952))
* **takeoff:** opt-in push_quantity copies measured value into the linked BOQ position ([a469170](https://github.com/Mourdi59/MD_OCERP/commit/a469170418319bb585f1a88a7ef3683262a22d01))
* **tendering:** UX polish + outlier highlighting + GAEB X83 + smarter award rec ([f8cc181](https://github.com/Mourdi59/MD_OCERP/commit/f8cc181bf875daf7c1a0396ec546e1e8ee6231f6))
* **ui:** &lt;MultiCurrencyTotal&gt; for honest cross-currency rollups (CRM, PropDev, Finance) ([96b3c74](https://github.com/Mourdi59/MD_OCERP/commit/96b3c74a4099c91a2cbd04698981f6d0eea69671))
* **ux:** expand &lt;RecoveryCard&gt; to 18 more list pages (401/403/error states) ([0506127](https://github.com/Mourdi59/MD_OCERP/commit/05061275cfd7fe7b87413863ea262c70f5e8d501))
* **v5.2.8 polish:** settings compactness + dark-mode tour + marketing site ([3e5b8d6](https://github.com/Mourdi59/MD_OCERP/commit/3e5b8d62e373ac84e8e4e733dc4f542c1101af00))
* **validation:** add BC3 / FIEBDC-3 rule pack + wire ES + LATAM regions ([a05893a](https://github.com/Mourdi59/MD_OCERP/commit/a05893af770e19d3045b29265273195d96d6aa5c))
* wire MoC/NCR cross-module event subscribers ([976bdf5](https://github.com/Mourdi59/MD_OCERP/commit/976bdf57f0ad188cce49d29a7e29e2c9c9254a55))
* **worldwide:** Waves 23-29 — currency, units, tax, address, classification, calendars, phone ([c67cf28](https://github.com/Mourdi59/MD_OCERP/commit/c67cf28bef9f5649e324a8aaa7088a23ad060844))


### Bug Fixes

* **a11y:** app-shell button-name on UploadQueue + RecentFAB + remove-task ([da8d60d](https://github.com/Mourdi59/MD_OCERP/commit/da8d60d579ef526725862d03fee2fe9a72aa8c02))
* **a11y:** aria-live/describedby on AI agents + chat + settings AI key ([d49d888](https://github.com/Mourdi59/MD_OCERP/commit/d49d88840188a573ab62fb75aca1441bc705428b))
* **a11y:** bump --oe-text-secondary to clear AA on tinted light surfaces ([0e6b396](https://github.com/Mourdi59/MD_OCERP/commit/0e6b396a26f9d7261f24f4077054993c006580b4))
* **a11y:** bump shell tokens further + V_DESIGN axe spec & artefacts ([09dbbcd](https://github.com/Mourdi59/MD_OCERP/commit/09dbbcd10f278abb7a7f8787f9a5c2eeee7f3416))
* **a11y:** bump WCAG-AA contrast on text-oe-blue + bg-oe-blue-subtle pairs ([4596db5](https://github.com/Mourdi59/MD_OCERP/commit/4596db55b181670044b6f7c1219cecc6f55b4924))
* **a11y:** close 10 deferred findings on QuickEstimatePage (P1+P2) ([f0ae5b1](https://github.com/Mourdi59/MD_OCERP/commit/f0ae5b1a197b366e9e46cd7667710103228247aa))
* **a11y:** dark-mode --oe-blue-dark token now reads on dark surface ([4c65ae2](https://github.com/Mourdi59/MD_OCERP/commit/4c65ae268cf5d2e98de4ef94acd1d0042dcd710f))
* **a11y:** design-token contrast WCAG AA for text-tertiary/quaternary ([cc3643a](https://github.com/Mourdi59/MD_OCERP/commit/cc3643a88a08daed0e4ff4f4795be73faa9dfeaf))
* **a11y:** drop dangling aria-controls + add role=presentation to booking overlay ([1b2e19c](https://github.com/Mourdi59/MD_OCERP/commit/1b2e19c16132a37d57c144d75fb5bac3ce50e5b0))
* **a11y:** LanguageSwitcher button-name + decorative chevron aria-hidden ([f8152eb](https://github.com/Mourdi59/MD_OCERP/commit/f8152eb76b5b152ae6ad95e40880908c4da00df5))
* **a11y:** orphan-li axe violations in Sidebar add-module CTA tiles ([66d744c](https://github.com/Mourdi59/MD_OCERP/commit/66d744c4d046e7b5989c9512a5017c2be0f00f5e))
* **a11y:** revert dark-mode --oe-blue-dark to saturated blue for button bg ([acc0826](https://github.com/Mourdi59/MD_OCERP/commit/acc0826ee183f1e778f1cf3829f99b57026c581c))
* **a11y:** split blue-on-tint text into theme-aware --oe-blue-text token ([804147e](https://github.com/Mourdi59/MD_OCERP/commit/804147e32468a8fc6720eac18f5e73885fe23714))
* **a11y:** WCAG-AA contrast — 5 semantic tokens raised, fixes ~700 of 863 ([059acae](https://github.com/Mourdi59/MD_OCERP/commit/059acaeeef6eff7f1c149753e2df8d4a6a236fec))
* **accommodation:** re-apply booking-overlap guard lost to NTFS junction race in V6 ([a9dc60e](https://github.com/Mourdi59/MD_OCERP/commit/a9dc60e5c041200cb80ebeab08eff976fd2b45a8))
* **accommodation:** reject overlapping live bookings on same room (S06 bug) ([7c8f95b](https://github.com/Mourdi59/MD_OCERP/commit/7c8f95b20b02a288d5bee3466430391cbd8c4886))
* add stdlib-only ReportRenderer (no Jinja/WeasyPrint to honour the 2-GB-VPS lightweight constraint), wire it into generate_report to render+store the HTML body, surface it via GET /reports/{id}/content (404/410/200), and cover with 7 pytest cases. ([53d1ca0](https://github.com/Mourdi59/MD_OCERP/commit/53d1ca0e1586e27795e43a82c6dc8913521ccc7b))
* **ai:** R7 audit — IDOR + rate-limit + prompt-isolation + magic-byte uploads + RBAC ([f7a7c05](https://github.com/Mourdi59/MD_OCERP/commit/f7a7c051d2351b24a77cd4209543beb6a940d75a))
* **alembic:** renumber geo_hub geocode_cache v3124 → v3127 after propdev wave race ([06fb803](https://github.com/Mourdi59/MD_OCERP/commit/06fb8039943e34bb836c9c1827fdd76e681d9e68))
* **alembic:** renumber pricing v3124 → v3125 after analytics race ([18533b6](https://github.com/Mourdi59/MD_OCERP/commit/18533b61812ae3eac1ec50d5d47177c00262a6e6))
* **alembic:** set v3127_geo_hub_geocode_cache revision + down_revision after rename ([69ebf3c](https://github.com/Mourdi59/MD_OCERP/commit/69ebf3c861e2eec5d8820e3e6bde0678c49fea04))
* **alembic:** v3143 use batch_alter_table for SQLite FK column adds ([22966e3](https://github.com/Mourdi59/MD_OCERP/commit/22966e3f2461367cdd2a47a86d878d9470ad18d2))
* **audit-gates:** register CDE Gate B under short code 'B' ([80cfb1e](https://github.com/Mourdi59/MD_OCERP/commit/80cfb1eb017e624e96f3797013924bf67deb97e2))
* **auth:** audit-log auth events + reset-token single-use + live-role sync ([6426d3b](https://github.com/Mourdi59/MD_OCERP/commit/6426d3b9bdb4783bc80661f97694e9b24836eca4))
* **auth:** demo email + any password mints tokens (BUG-D02) ([4d06354](https://github.com/Mourdi59/MD_OCERP/commit/4d063541a69ae3e2234c61ae2c1b882bfac3f5d3))
* **auth:** persist dev JWT secret to ~/.openestimator/.jwt-secret ([2398d26](https://github.com/Mourdi59/MD_OCERP/commit/2398d26aa06d2d1c4b7c4acb4dd4b2c1388a2ce7))
* **bid_management:** R7 audit — bidder/owner role split + IDOR + Decimal + FSM + RBAC ([6130775](https://github.com/Mourdi59/MD_OCERP/commit/6130775f55f5d78592a3c77e2379f5b1887ba438))
* **bim_hub:** version-tolerant RvtExporter CLI + exit-15 fallback + outdated-converter UX ([2ae53fb](https://github.com/Mourdi59/MD_OCERP/commit/2ae53fbd7cae7f6ca8e29234f5daf1d3e0480236))
* **bim-federations:** replace broken 3D tab with member-model link list ([22bf474](https://github.com/Mourdi59/MD_OCERP/commit/22bf474e38227b8bb34972d04ff9fdb6b4512127))
* **bim:** apply section-box clipping planes to renderer ([8d362a4](https://github.com/Mourdi59/MD_OCERP/commit/8d362a4c53a8ea8d9a1e75a8fb76cf720365699c))
* **bim:** canvas ARIA labels, FederatedViewer dark-mode, overriddenMeshes cleanup ([1206dad](https://github.com/Mourdi59/MD_OCERP/commit/1206dad169fcef02c2ebc74b698cb2667000a39f))
* **bim:** COLLADA namespace prefix crashes viewer + degraded model status unhandled ([94d5be8](https://github.com/Mourdi59/MD_OCERP/commit/94d5be8117f9c87cccde81351d5ba409a768d34a))
* **bim:** DDC v18.3 CLI compatibility + showcase re-ingest tooling ([8f3ff47](https://github.com/Mourdi59/MD_OCERP/commit/8f3ff4734ee090cb354529e4b0762863f880a51c))
* **bim:** keep Category / TypeName / Buckets tree stable when filtering ([c8cb722](https://github.com/Mourdi59/MD_OCERP/commit/c8cb7220f3af751749469b4d581375700bb63d38))
* **bim:** make filter-panel chip counts respect active filters (facet UI) ([6dd3446](https://github.com/Mourdi59/MD_OCERP/commit/6dd344669af44b05a0fef3959f54ecfac3f66b92))
* **bim:** property search supports federation viewer via per-model picker ([24e365a](https://github.com/Mourdi59/MD_OCERP/commit/24e365a5ad80a952134b99cef40f18283c6cbaad))
* **bim:** restore correct grouping when filtering by category/type ([5fc5543](https://github.com/Mourdi59/MD_OCERP/commit/5fc5543b1023e9fe4e91150c568dd35805d445f4))
* **bim:** show full geometry by default on ?sel= deep-link (don't auto-isolate) ([6f7f572](https://github.com/Mourdi59/MD_OCERP/commit/6f7f572a168e4924343dd8d07cb1132d8aa01a7b))
* **bim:** wire walk-mode camera updates to on-demand renderer ([46ac723](https://github.com/Mourdi59/MD_OCERP/commit/46ac7234eeacea9d86fafa39765f8741f01fc6e4))
* **boq/importers:** BC3 measurement qty + Excel 'Code' header → classification ([775383b](https://github.com/Mourdi59/MD_OCERP/commit/775383b3f427a48ec7b4a5f73ac583c1ead998a5))
* **boq:** keep currency popover open + auto-focus FX rate when missing ([#157](https://github.com/Mourdi59/MD_OCERP/issues/157)) ([bedd112](https://github.com/Mourdi59/MD_OCERP/commit/bedd112d137bf7a0128f5132c9962cdf2b448618))
* **boq:** plug three IDOR/precision gaps found in deep audit ([0f93b69](https://github.com/Mourdi59/MD_OCERP/commit/0f93b69e581516e15360e1e842443001414a992b))
* **boq:** recompute section subtotal when a resource currency changes ([#157](https://github.com/Mourdi59/MD_OCERP/issues/157)) ([8ad3348](https://github.com/Mourdi59/MD_OCERP/commit/8ad3348a82955e7e65530397ed2ff07370979e23))
* **boq:** surface missing-FX warning at section level ([#157](https://github.com/Mourdi59/MD_OCERP/issues/157)) ([9dc0991](https://github.com/Mourdi59/MD_OCERP/commit/9dc0991ce0944486f087676dd16fcbf3d76afd3c))
* **build:** add Wave 24 unit formatters to unblock PyPI wheel build ([893807d](https://github.com/Mourdi59/MD_OCERP/commit/893807d82ee12b343b33bac38acc86081a83fc1d))
* **build:** drop dead useLLMRun import in AdvisorPage ([cccc3a5](https://github.com/Mourdi59/MD_OCERP/commit/cccc3a5599c0eceefe6dd719cd78c7b3bbae4169))
* **cad-explorer:** route convert_cad_to_excel through v18-aware builder ([3391271](https://github.com/Mourdi59/MD_OCERP/commit/3391271dbffc453faac9d605c3f0a822de3aa6dd))
* **carbon:** 3 correctness fixes — autofill direct-multiply, epd_international source, ingest re-fetch guard ([8f5787c](https://github.com/Mourdi59/MD_OCERP/commit/8f5787cf46e4a99141eef8c73f04f0208b53648b))
* **catalog:** always show full-name tooltip on row hover + add to card view ([8fad845](https://github.com/Mourdi59/MD_OCERP/commit/8fad8455947dc11929aea201cacde01043e9655a))
* **catalog:** portal-rendered tooltip escapes table overflow clipping ([c3e4221](https://github.com/Mourdi59/MD_OCERP/commit/c3e4221ffae4e8795954b9b0cb621f488121a495))
* **catalog:** show full resource name on hover (closes [#156](https://github.com/Mourdi59/MD_OCERP/issues/156)) ([ccf01ab](https://github.com/Mourdi59/MD_OCERP/commit/ccf01ab7753c0d5970da5c304cd6dda47485ab5f))
* **catalog:** tooltip z-index — hover:z-50 on row + z-[70] on popover ([1e819ad](https://github.com/Mourdi59/MD_OCERP/commit/1e819adb517845102c7c294b09327595425136ac))
* **chat:** sanitize markdown render with DOMPurify to block XSS ([d4c3ff0](https://github.com/Mourdi59/MD_OCERP/commit/d4c3ff0070bf23da7f4803251b10bad63e4ea4a9))
* **ci:** bring ruff fixes up to date with CI's newer ruff version ([ebe7edc](https://github.com/Mourdi59/MD_OCERP/commit/ebe7edc30da11f469b7e9115b5d7df50dd49a94f))
* **ci:** correct PyPI sanity-check script — prefix wheel with dist/ ([d4125ac](https://github.com/Mourdi59/MD_OCERP/commit/d4125acc463522958e9126076bf4389c40ff6af3))
* **ci:** drop pre-copy of frontend/dist that produced duplicate wheel entries ([85387e7](https://github.com/Mourdi59/MD_OCERP/commit/85387e753b0685606f7792fae362777beda04d46))
* **ci:** make backend ruff check + format pass on main ([e109b06](https://github.com/Mourdi59/MD_OCERP/commit/e109b0685d578d5393929b263e5af60798dee084))
* **ci:** make frontend eslint pass on main ([17690f3](https://github.com/Mourdi59/MD_OCERP/commit/17690f357c8f1eee7cbb38b9f8b510c1d675a1cd))
* **ci:** silence zero-width-guard on intentional CSV BOM ([4f7e8a4](https://github.com/Mourdi59/MD_OCERP/commit/4f7e8a4ecc659724dadeb06d0a94db4dc55c6986))
* **clash:** repair mojibake in CAD-BIM picker strings ([16bad55](https://github.com/Mourdi59/MD_OCERP/commit/16bad552204957fceb7cfa6d5fe0ebefa11b4760))
* **cli+marketing:** tidy startup banner + news article CTAs and hero images ([a118cfa](https://github.com/Mourdi59/MD_OCERP/commit/a118cfafaf10cf2fa41268f26c390c6f9396e95b))
* **coordination:** repair dashboard load (root cause: stale active project id 404s every endpoint) ([d97ade6](https://github.com/Mourdi59/MD_OCERP/commit/d97ade6fc12ed9dcb217b47eb88efe97e6ebcffa))
* **costs:** LanceDB filter injection guard + parquet cache staleness ([8328e79](https://github.com/Mourdi59/MD_OCERP/commit/8328e79f1b55f9e080a756c2c2a509270d3f3695))
* **crm,service:** R7 audit — IDOR chain + PII redaction + GDPR forget + ticket FSM + RBAC ([362599c](https://github.com/Mourdi59/MD_OCERP/commit/362599c02f55edfecf4a133faed9e4029581749e))
* **crm:** extend forget_lead GDPR scrub to source field and activity outcome ([6cfbaab](https://github.com/Mourdi59/MD_OCERP/commit/6cfbaabb5360420d96cb9456ca4dfba94fa702c7))
* **daily_diary:** clarify _ensure_can_transition same-status semantics ([719f056](https://github.com/Mourdi59/MD_OCERP/commit/719f056ab8da77ffdb0780ffdbb4d1ea6e7923bc))
* **daily-diary:** wire delete button + W22 audit + v5.2.2/v5.2.3 news ([425c4db](https://github.com/Mourdi59/MD_OCERP/commit/425c4db1faaef9225d4ae774e30162136b11246a))
* **dashboard:** coerce Decimal-string money in totalValue reducer ([030dc3d](https://github.com/Mourdi59/MD_OCERP/commit/030dc3da674dba539f1a74b26351c5b899be84cd))
* **dashboard:** harden Operations snapshot against undefined payload fields ([00c963f](https://github.com/Mourdi59/MD_OCERP/commit/00c963fb980a6abffa1dffeaeacc10316759ccef))
* **dashboard:** remove duplicate DashboardRollupProvider import ([12285a2](https://github.com/Mourdi59/MD_OCERP/commit/12285a26ce463c017a66032514f95f5c7c4e4890))
* **dashboards:** add POST /rollup/ endpoint + cap activity/validation query sizes ([de9289b](https://github.com/Mourdi59/MD_OCERP/commit/de9289bee1c88225f6eee4cc17482a52bfa25e09))
* **deps:** floor fastapi at 0.116 — 0.115.x crashes 204 routes ([#157](https://github.com/Mourdi59/MD_OCERP/issues/157)) ([c07c43c](https://github.com/Mourdi59/MD_OCERP/commit/c07c43c2ca561b554ec7503831ed7260217b2099))
* **dev:** dedupe react/react-dom to stop recharts ErrorBoundary crash ([1abf8df](https://github.com/Mourdi59/MD_OCERP/commit/1abf8df135ee05f1edbc3d48320c06f63af12ad6))
* **documents:** R7 audit — IDOR + path-traversal + size-cap + presigned-TTL + RBAC ([cb65af3](https://github.com/Mourdi59/MD_OCERP/commit/cb65af3ba98323aceb0621ce13b4ac97c5d5a302))
* **dwg-takeoff:** honest progress UI during 5-min DWG conversion ([2c93be3](https://github.com/Mourdi59/MD_OCERP/commit/2c93be3ea92e511afa3703ef1a1b70a372548f10))
* **dwg/cad:** wheel-install converter discovery + DWG v18-aware CLI ([686ea3a](https://github.com/Mourdi59/MD_OCERP/commit/686ea3a4eb1265df258fc491117bbacd031dcbb9))
* **fieldreports:** add IDOR guard to approve_report endpoint ([e3ee4a2](https://github.com/Mourdi59/MD_OCERP/commit/e3ee4a24567f433be8dd279bdaae210d34ea3e34))
* **files:** sidebar counts honour q + extension filters ([a19fead](https://github.com/Mourdi59/MD_OCERP/commit/a19fead13137039fd11b3660986eea5a898bd142))
* **finance:** assign Decimal (not str) to budget.actual in pay_invoice actuals sweep ([f434812](https://github.com/Mourdi59/MD_OCERP/commit/f4348122f56428f5cbaf0f74d9f65ebcdf141fb6))
* **finance:** R7 audit -- IDOR + escrow idempotency + Decimal arithmetic + audit trail + RBAC ([740fd9a](https://github.com/Mourdi59/MD_OCERP/commit/740fd9ab733792d77e3e4e37b8c1b6ca2e61dab2))
* **finance:** replace float() with Decimal in budget Excel export to prevent precision loss ([e732f13](https://github.com/Mourdi59/MD_OCERP/commit/e732f130af753ee0af4d8b2b3d36542c53a6be61))
* **geo_hub:** R7 audit — IDOR + magic-byte uploads + bbox sanitization + RBAC (non-raster surface) ([9012fed](https://github.com/Mourdi59/MD_OCERP/commit/9012fed9682b5449141b59c146476e99d4a5947a))
* **geo-hub:** explicit OSM base layer kills Cesium Ion default dependency ([3edd384](https://github.com/Mourdi59/MD_OCERP/commit/3edd384294c6070d92c7e1347641b2fee7c0e987))
* **geo,notifications:** raster-overlay delete RBAC + sweep endpoint + webhook circuit-breaker ([2e9a365](https://github.com/Mourdi59/MD_OCERP/commit/2e9a365683c98e29a1a8c03dbd0594f92daba470))
* **geo:** guard OverlayLayer cesium effects against undefined viewer (scene-crash) ([5f60c44](https://github.com/Mourdi59/MD_OCERP/commit/5f60c443e6f3aab4debbc9100f19a9326ed26065))
* **geo:** make Project/Development tabs navigable + searchPin reliability ([a161dfb](https://github.com/Mourdi59/MD_OCERP/commit/a161dfb39bc2a861a6bd29a16b285e15d8a3cea3))
* **geo:** mode-picker in-page dialog + autocomplete searching row (v5.4.3) ([18a1185](https://github.com/Mourdi59/MD_OCERP/commit/18a11858daa6a4be7368fd4c3cfc9cc8f8b1ea36))
* **geo:** silence Cesium ion default-token warning with sentinel ([6dc3297](https://github.com/Mourdi59/MD_OCERP/commit/6dc3297f8a29cc32262d7113c3b9e9304d9bcaa9))
* **hse/procurement/submittals:** R8 residuals — JSA FSM IDOR, PO total stale on item edit, submittal CAS race ([ee1737d](https://github.com/Mourdi59/MD_OCERP/commit/ee1737db9067a425a271870661683121a5350752))
* **hse:** add _guard_project to JSA FSM transition endpoints (submit/approve/activate/archive). ([ee1737d](https://github.com/Mourdi59/MD_OCERP/commit/ee1737db9067a425a271870661683121a5350752))
* **install:** close 5 fresh-install paper-cuts — hatch force-include, demo password env, vite port + proxy + duplicate include ([ad2d36e](https://github.com/Mourdi59/MD_OCERP/commit/ad2d36e1a8bb6d9d6b53a9aa11478f8c115583a2))
* **integrations:** drop Example webhook seed + normalize test route slash ([7b0b3f9](https://github.com/Mourdi59/MD_OCERP/commit/7b0b3f950278fd1e6019d1669d6e2c90b1848fe0))
* **integrations:** R7 audit — SSRF + secret redaction + HMAC + rate-limit + RBAC ([8dfb16f](https://github.com/Mourdi59/MD_OCERP/commit/8dfb16f422ee60ca1c47f855dd2b8e5fdbe86045))
* **login:** dark-mode honeycomb text + drop white outline under form ([d738599](https://github.com/Mourdi59/MD_OCERP/commit/d73859923534ecc9a65bdabd745214226397c872))
* **login:** em-dashes → hyphens on /login page + 24 locales ([07452b2](https://github.com/Mourdi59/MD_OCERP/commit/07452b229243ee83ceebf0af340b3f353f06c115))
* **login:** unify GitHub + Community footer cards to neutral black palette ([7f12e3c](https://github.com/Mourdi59/MD_OCERP/commit/7f12e3cd15767806aa591d92826d5f85f6aa1179))
* **marketing-i18n:** decode HTML entities in locale JSONs (513 strings × 20 locales) ([02b1c86](https://github.com/Mourdi59/MD_OCERP/commit/02b1c8688744712f96b724e9b57bceef22471b89))
* **marketing/article-nav:** match live site menu — add Maturity, drop stale Pricing ([571e764](https://github.com/Mourdi59/MD_OCERP/commit/571e764c1f609233204e018285330a146ab3c2dc))
* **marketing/article:** remove Boiko-quote pull-quote block ([bb9e38c](https://github.com/Mourdi59/MD_OCERP/commit/bb9e38cf096692c6d809921dd1fca6353ab812f9))
* **marketing/news-widget:** bump rail breakpoint, scope rail-only styles, dynamic height ([9287555](https://github.com/Mourdi59/MD_OCERP/commit/92875558fd361770b539bff1bcdc8b7b66818d7b))
* **marketing:** remove duplicate 'All modules' grid (kept top 'One install' overview) ([4a3084f](https://github.com/Mourdi59/MD_OCERP/commit/4a3084f6a66a0713052ed0ad6fec00b5ccaa595b))
* **markups,files:** IDOR on scale list, scheduler re-registration, canvas-fade stale closure ([080e247](https://github.com/Mourdi59/MD_OCERP/commit/080e24786c11d7c81f986575048cfcded6bdaff4))
* **markups/test:** add missing assignee_id to test factory (unblocks v5.5.2 build) ([98b2b36](https://github.com/Mourdi59/MD_OCERP/commit/98b2b365a543730f49e092bc558ae16e954cb192))
* **markups:** break TDZ on drawAnnotations via forward ref pattern ([cd70308](https://github.com/Mourdi59/MD_OCERP/commit/cd70308d5af917f55a817d80fceb0d80fabd2396))
* **match:** blend BGE rerank score instead of replacing prior ([e925bde](https://github.com/Mourdi59/MD_OCERP/commit/e925bde03aa40252733786a19a013c93c8640987))
* **match:** canonical IFC class fold + non-billable short-circuit ([41288ff](https://github.com/Mourdi59/MD_OCERP/commit/41288fff37dfb1e425db684b2dd09a43c8859550))
* **match:** populate ifc_class + structured fields from BIM extractor ([830e50d](https://github.com/Mourdi59/MD_OCERP/commit/830e50d604c513e5fc7d3c88bef0f01b90b6176f))
* **money:** close 137 remaining float-&gt;Decimal-as-string conversions (v3 §10 invariant) ([db69652](https://github.com/Mourdi59/MD_OCERP/commit/db6965239d08237952139889daafc10824ff6dcd))
* **money:** convert top 40 float fields to Decimal-as-string (137 deferred to docs/MONEY_FLOAT_REMAINING.md) ([e0a17a1](https://github.com/Mourdi59/MD_OCERP/commit/e0a17a13e77e9766fda68db6f6ae6ea39923444e))
* **money:** harden shared formatters against Decimal-string inputs ([6859b8d](https://github.com/Mourdi59/MD_OCERP/commit/6859b8d79718648b0614a0e150a955d64a248177))
* **money:** pass explicit currency to MoneyDisplay (post-Wave2 strict-mode sweep) ([9d26317](https://github.com/Mourdi59/MD_OCERP/commit/9d263177e006eff981d42205f826e6decc195930))
* **procurement:** R7 audit -- IDOR + competitor-leak guard + Decimal + magic-byte + FSM + RBAC ([86582fb](https://github.com/Mourdi59/MD_OCERP/commit/86582fb19f1e15c64f5e13291e192668a518f52d))
* **procurement:** recompute amount_subtotal + amount_total when PATCH /{po_id} ([ee1737d](https://github.com/Mourdi59/MD_OCERP/commit/ee1737db9067a425a271870661683121a5350752))
* **procurement:** remove hardcoded EUR default from PurchaseOrder model and POResponse schema ([f34773b](https://github.com/Mourdi59/MD_OCERP/commit/f34773bf78ab5575cb697e177ea7dbdeb5aa94f0))
* **projects:** grant team members access to projects and BOQs ([#164](https://github.com/Mourdi59/MD_OCERP/issues/164)) ([0459959](https://github.com/Mourdi59/MD_OCERP/commit/04599591382e8df0bde1ea4448f8b1acf93ba146))
* **propdev:** block double-reservation race + kanban money as decimal strings ([e6843fe](https://github.com/Mourdi59/MD_OCERP/commit/e6843fe3e8ad8083b7ea03739787e763a42c66b9))
* **property_dev:** bulk-ops follow-up — webhook publish guard + admin/manager fixture + reservation token regex ([8f5fbc9](https://github.com/Mourdi59/MD_OCERP/commit/8f5fbc9b7057e376ecac70f633eec1fbe9e4d943))
* **property_dev:** cache PriceList PK before update_fields to avoid lazy-load crash ([ec4ac12](https://github.com/Mourdi59/MD_OCERP/commit/ec4ac12c0fd736da184b24f70aaa8e1a48478008))
* **property_dev:** R8 audit — close remaining 129 endpoints (IDOR + Decimal + FSM + RBAC) ([8c82eba](https://github.com/Mourdi59/MD_OCERP/commit/8c82eba04662f8dbd9c9710f5f0e3d1fbe065dc8))
* **punchlist:** IDOR on remove_photo + missing verify-permission gate ([1b3f0c0](https://github.com/Mourdi59/MD_OCERP/commit/1b3f0c05927eaefd0f84ef978521e39a5c1a7412))
* **pwa:** kill-switch sw.js — auto-unregister stale prod SW that pinned old /assets bundle ([4e34f46](https://github.com/Mourdi59/MD_OCERP/commit/4e34f46351f9dbe1f1f4839d9e4ce4f8f1d14c35))
* **pwa:** precache .mjs + bypass worker fetches from CacheFirst ([1bb49eb](https://github.com/Mourdi59/MD_OCERP/commit/1bb49eba6581e6d42e2d9a10cf55540d2a25ef97))
* **qa/V_WAVE5:** correct route paths — slugs mount at /&lt;slug&gt;, not /modules/&lt;slug&gt; ([6a3980f](https://github.com/Mourdi59/MD_OCERP/commit/6a3980f5fc9fce48bf6427f6cd46c56f886ae0a6))
* **qa:** add QA_ROUTE_LIMIT env var for trimmed harness sweeps ([f547784](https://github.com/Mourdi59/MD_OCERP/commit/f54778438e704b02ab51fe34f71fb3e1d980d053))
* **qa:** dismiss public-demo modal in Playwright screenshot harness ([d740a25](https://github.com/Mourdi59/MD_OCERP/commit/d740a25e6eef6e4ac1cbf6033f61b20ee5ba0bbe))
* **qa:** parameterize harness with QA_LOCALE / QA_THEME / QA_VIEWPORT env vars ([07141cf](https://github.com/Mourdi59/MD_OCERP/commit/07141cf92ee7caf757233377d58b01896f532f8f))
* **qms,daily_diary:** R7 audit — IDOR + FSM + uploads magic-byte + signed-immutable + RBAC ([f305277](https://github.com/Mourdi59/MD_OCERP/commit/f305277c67f48cb720adeb1ab52a52aa11b1edc4))
* **qms:** audit-log NCR PATCH transitions + guard close_ncr TOCTOU race ([a8159a8](https://github.com/Mourdi59/MD_OCERP/commit/a8159a81c7da0c2d2f7633bb6fcc6d63be747647))
* **regional-exchange:** type the route component as ComponentType&lt;unknown&gt; ([96e6b77](https://github.com/Mourdi59/MD_OCERP/commit/96e6b77977e62ede01346493bf10d600ae811a75))
* **reporting:** Content-Disposition header injection + access-before-fetch ordering ([dafbcf7](https://github.com/Mourdi59/MD_OCERP/commit/dafbcf79539c5ec899ad25cb4a29bca2cb907956))
* **reporting:** restore missing renderer + empty state ([a2a277b](https://github.com/Mourdi59/MD_OCERP/commit/a2a277b224d5094f1ebb98114dd84cf0eb1606f8))
* **reporting:** restore missing renderer on /reporting ([53d1ca0](https://github.com/Mourdi59/MD_OCERP/commit/53d1ca0e1586e27795e43a82c6dc8913521ccc7b))
* **reports:** R7 audit — IDOR + HTML injection + presigned TTL + Decimal + RBAC ([5e24be7](https://github.com/Mourdi59/MD_OCERP/commit/5e24be73d0679db9410892a174e61d54ba7d1292))
* **routes:** authed `/` redirects to /dashboard, not /projects ([2ed4d99](https://github.com/Mourdi59/MD_OCERP/commit/2ed4d996a3b760a64badf5d3eb1ba21bd40585fd))
* **routing:** /geo-hub Navigate alias -&gt; /geo (regression caught no canonical alias) ([a07841a](https://github.com/Mourdi59/MD_OCERP/commit/a07841adc97501590d9b177945e286128865bf84))
* **schedule_advanced:** R7 audit — IDOR + Decimal + FSM + RBAC ([c96f8bb](https://github.com/Mourdi59/MD_OCERP/commit/c96f8bbbe9df865772766d4d5fe9a5e4310b6c1c))
* **schedule,contracts:** CPM is_critical uses &lt;=0, fix cycle-path root gap, guard CO on closed contracts ([7491fa5](https://github.com/Mourdi59/MD_OCERP/commit/7491fa520ac9a6eb6d52acc3a4fd5f568c402993))
* **settings:** alias legacy ?tab=bimcad to converters ([6707bfc](https://github.com/Mourdi59/MD_OCERP/commit/6707bfc9d812e4cb140054b6175b6080c6b55194))
* **settings:** drop CAD/BIM prefix from Converters tab title + description (was misread as a leftover BIM/CAD section) ([99de9d3](https://github.com/Mourdi59/MD_OCERP/commit/99de9d3fa0f23593f1de2db4f1993e223cfaba48))
* **submittals:** prevent concurrent double-approval race in approve_submittal(). ([ee1737d](https://github.com/Mourdi59/MD_OCERP/commit/ee1737db9067a425a271870661683121a5350752))
* **takeoff:** handle docId+measurementId+tab query params from /markups deep-link ([14836d5](https://github.com/Mourdi59/MD_OCERP/commit/14836d5b70142f167b4842cf0af74c92e91dd251))
* **takeoff:** inline-dict PDF encryption detection, dark-mode canvas labels, upload error surfacing ([7e9a807](https://github.com/Mourdi59/MD_OCERP/commit/7e9a80714cc21de37f1a8b51a0bcab27c3e89a8e))
* **takeoff:** PDF download 403 — accept both .openestimate and .openestimator data dirs ([864962e](https://github.com/Mourdi59/MD_OCERP/commit/864962ecb28d78eb6c0c06cd794a2c94264dccbf))
* **tendering:** token_hash leak, award-delete FSM revert, concurrent submit race ([9ad6a92](https://github.com/Mourdi59/MD_OCERP/commit/9ad6a92631660c5fb3f5a08fcdf36ee5995457fa))
* **tendering:** wave-12 audit fixes (4 issues) ([72fb28c](https://github.com/Mourdi59/MD_OCERP/commit/72fb28c1824e87522e0ab8c5cfe569562f20214e))
* **types:** clean tsc — PlotStatus held/blocked completion + PropDevDocType 6 new doc records + InventoryMap MoneyDisplay prop + HSE select cast ([8af6d0f](https://github.com/Mourdi59/MD_OCERP/commit/8af6d0ff98d27c225d2ea53542822bf7151f09eb))
* **users:** set_user_module_access silently dropped metadata payload ([1a3d29a](https://github.com/Mourdi59/MD_OCERP/commit/1a3d29a9aec1d9fe7f2ebd367cb0b7e52e7340d9))
* **ux:** 5 audit blockers — admin-only dev routes + collapse dual tours + MoneyDisplay strict + DateDisplay in notifications + rollup error banner ([7366b3b](https://github.com/Mourdi59/MD_OCERP/commit/7366b3b0d4937c0bd4ea9b7825a26689a85d367c))
* v5.2.2 — dashboard route + W10/W13/SAF-A3 + a11y bundle ([85d1aea](https://github.com/Mourdi59/MD_OCERP/commit/85d1aea6601a5ded2c08c0783ab37a296776a2ac))
* v5.2.3 — issue [#162](https://github.com/Mourdi59/MD_OCERP/issues/162) vector backend gate + .env.example clarity ([a66d0dd](https://github.com/Mourdi59/MD_OCERP/commit/a66d0dd0de5f7767f6e8284ddcb9bed4c970dc68))
* **validation:** register missing BOQUnitSystem+ClassificationNudge rules; fix stale SKIPPED score assertion ([17a164f](https://github.com/Mourdi59/MD_OCERP/commit/17a164f53b30d5402b71f30b417416d4e8702adf))
* **variations,change_orders:** R8 — race on convert_vr_to_vo, missing RBAC on CO GET, missing execute endpoint ([a08c274](https://github.com/Mourdi59/MD_OCERP/commit/a08c2742fd2e3961027e05d516969858fa209625))
* **variations,changeorders:** R7 audit — IDOR + Decimal + FSM + RBAC + cross-module atomicity ([1f06d0e](https://github.com/Mourdi59/MD_OCERP/commit/1f06d0e2eb7b9d4b0682e37c14a60af5d61b9368))
* various patches (subset of [#161](https://github.com/Mourdi59/MD_OCERP/issues/161) — safe parts only) ([bb25043](https://github.com/Mourdi59/MD_OCERP/commit/bb25043455478086f7d5b78c974a1edd145d3b10))
* **whatsnew:** portal chip popovers so they paint above dashboard widgets ([82e6c30](https://github.com/Mourdi59/MD_OCERP/commit/82e6c30d3a6f970048dfff6324eb62cb33866712))


### Performance

* **bim_hub:** batch storage probes in model list endpoint ([a2cc449](https://github.com/Mourdi59/MD_OCERP/commit/a2cc4493a9e12905af8871d6aa85e6fcce1980a5))
* **boq:** add explicit indexes on FK columns (alembic v3123_boq_fk_indexes) ([e0f59be](https://github.com/Mourdi59/MD_OCERP/commit/e0f59bef4b0c7895d1184d1b7023600831c96fe7))
* **costs:** push ORDER BY + LIMIT into SQL (kill over-fetch + sort-in-memory) ([1ced962](https://github.com/Mourdi59/MD_OCERP/commit/1ced9629370302e67f8d86379c60b106c56bdab7))
* **projects:** bulk-guard the service loop (was unbounded) ([7083c87](https://github.com/Mourdi59/MD_OCERP/commit/7083c87d855d6d332a9b27a1d422bb6cdcae4613))
* **projects:** consolidate ProjectWidgets fan-out via /dashboard/rollup/ ([f80130b](https://github.com/Mourdi59/MD_OCERP/commit/f80130b41a19643843be50ce13aea53526c27c59))
* **projects:** replace in-memory code scan with SQL MAX aggregate ([0a049a9](https://github.com/Mourdi59/MD_OCERP/commit/0a049a9d5c28e6e90cdd76088056ad95894fd3b1))
* **schedule:** cap relationships fetch + add ?limit= param ([41a5d9f](https://github.com/Mourdi59/MD_OCERP/commit/41a5d9f9391cbb00b5adde01d48e81f3f44064c6))


### Code Refactoring

* **ai:** extract useLLMRun hook + lift formatters to shared/lib ([4574fcf](https://github.com/Mourdi59/MD_OCERP/commit/4574fcf61cb1673b16384daa2b76927969a52f71))
* **ai:** extract useLLMRun shared hook ([63b770a](https://github.com/Mourdi59/MD_OCERP/commit/63b770a13339603024d8367c601eea094745bd3c))
* **audit-gates:** lift CDE Gate B logic into generic registry (Epic H §H5) ([058a535](https://github.com/Mourdi59/MD_OCERP/commit/058a535f84dab00cb4087ad0dec4425586d9ed66))
* **bim:** move Begehung to top toolbar + drop duplicate ruler/section ([0f65e5f](https://github.com/Mourdi59/MD_OCERP/commit/0f65e5ff8c029b23ddfb855a0f80396980a99344))
* **property-dev:** split PropertyDevPage into per-tab modules (Wave 21 [#107](https://github.com/Mourdi59/MD_OCERP/issues/107)) ([0a060fc](https://github.com/Mourdi59/MD_OCERP/commit/0a060fcfc4746dc3acc0bcb10ef1db931ff19dc5))
* **regional-exchange:** delete 20 collapsed country modules (Wave 5 Epic I — I13/I14) ([a36f997](https://github.com/Mourdi59/MD_OCERP/commit/a36f997fc9c833388dfd243f34b72b77bf7b04a0))
* **shared:** lift formatters from ai/ to shared/lib/formatters ([a37c03d](https://github.com/Mourdi59/MD_OCERP/commit/a37c03d9391a3b309d41809ac707d853f60d8f5d))
* **ux:** extract &lt;RequiresProject&gt; + &lt;RecoveryCard&gt;, migrate 25 pages (audit blocker) ([e5b5b99](https://github.com/Mourdi59/MD_OCERP/commit/e5b5b9963df1bb44c5fd2e3cb9e46b1dc48630e9))
* **ux:** replace 21 window.confirm/alert with useConfirm/ConfirmDialog ([abaed57](https://github.com/Mourdi59/MD_OCERP/commit/abaed57f1f51b31783c7833e8eb1212d0738c616))


### Documentation

* **authors:** credit @Mourdi59 for BIM viewer bug fixes ([#159](https://github.com/Mourdi59/MD_OCERP/issues/159)) ([b2ef183](https://github.com/Mourdi59/MD_OCERP/commit/b2ef1833c376afdcec6b07a3ac992c7fd86ac396))
* **boq-importer-plugin:** plugin guide for country packs + native parsers (Wave 5 Epic I — I16) ([aae83dc](https://github.com/Mourdi59/MD_OCERP/commit/aae83dcc80032f2d73a358f47c54fc7dc33bad75))
* **changelog:** catch up CHANGELOG.md + Changelog.tsx through v5.3.0 ([17045ea](https://github.com/Mourdi59/MD_OCERP/commit/17045ea453eda674cc9738c169168b5f61416f34))
* **dwg-takeoff:** explain why BetaBanner is deferred to a header chip ([3c232cb](https://github.com/Mourdi59/MD_OCERP/commit/3c232cb70075ce991a78493be53b87c987a8ec0e))
* **i18n:** add 2026-05-28 coverage audit + per-locale gap analysis ([92b36d3](https://github.com/Mourdi59/MD_OCERP/commit/92b36d30d1c2752c54b3072748a92476d9bd8ff2))
* **marketing:** article gets the main-site nav, drops the email framing, widens ([884903b](https://github.com/Mourdi59/MD_OCERP/commit/884903b855868273fb405525024279c9afdef002))
* **marketing:** backfill v3 release articles + fix broken og:image ([3eef054](https://github.com/Mourdi59/MD_OCERP/commit/3eef054f8b015d8c6914d977022841f9db83cebb))
* **marketing:** backfill v5.x release news pages ([be958cc](https://github.com/Mourdi59/MD_OCERP/commit/be958cca029168c8764a6527892f2d393746c0b8))
* **marketing:** publish OpenConstructionERP concept paper as news article ([9382b40](https://github.com/Mourdi59/MD_OCERP/commit/9382b40dddc3575732b270220b82605e8541978d))
* **marketing:** rewrite concept-paper article as long-form piece + drop fake news cards ([9e7bd19](https://github.com/Mourdi59/MD_OCERP/commit/9e7bd1939f42859ac4565870646296a5b16a8939))
* **marketing:** v5.2.7 release news page ([58e5383](https://github.com/Mourdi59/MD_OCERP/commit/58e5383fa52869063afc2c3ed7dfc6b5d1bab040))
* **modules:** add Formwork Management module design specification ([27b1731](https://github.com/Mourdi59/MD_OCERP/commit/27b17310c87d415f5f505cffbb25fbc3107c1a1e))
* neutralize internal working-notes references across code comments and configs ([e8dda0c](https://github.com/Mourdi59/MD_OCERP/commit/e8dda0c5aa0726efaf9bf2137a7c04f0fd8f9126))
* **news:** add v5.5.0 marketing article + news.html index card ([acea280](https://github.com/Mourdi59/MD_OCERP/commit/acea280001007236c67ffd44d3fb13d92ac6c32c))
* **qa:** 2026-05-28 verification sweep ([5990fe6](https://github.com/Mourdi59/MD_OCERP/commit/5990fe63049ed01176fbc442fb912f733cc408e0))
* **qa:** add verification REPORT.md alongside the 2026-05-28 sweep artifacts ([55089da](https://github.com/Mourdi59/MD_OCERP/commit/55089da08acf0dfff89f66ece25bab05cf07a112))
* **qa:** comprehensive 6-phase test plan covering all 112 modules + 10 personas + regression matrix ([692278e](https://github.com/Mourdi59/MD_OCERP/commit/692278ef69927e2ebdd7f3836e7e4d832e2f67f7))
* **qa:** fresh-install runbook + clean-room install verification results ([43613d9](https://github.com/Mourdi59/MD_OCERP/commit/43613d9cfe4aaefbc9157364cfb9059ded8c6e91))
* **qa:** UX weaknesses audit — 12-dimension review across all routes ([1e5b8ac](https://github.com/Mourdi59/MD_OCERP/commit/1e5b8acf009386f802da6b921242e6f46d0cade0))
* **readme:** add 2 missing screenshots + whitelist docs/screenshots/*.jpg ([b233a30](https://github.com/Mourdi59/MD_OCERP/commit/b233a3052877be31c27b3bd8c284c5a10f522bbd))
* **readme:** align What's New body with v5.2.5 (Epic B/C/H/I + install fix) ([ceea953](https://github.com/Mourdi59/MD_OCERP/commit/ceea953d881cfd9e90cc422a77267a59dd0c95f3))
* **readme:** modernize hero with [#1](https://github.com/Mourdi59/MD_OCERP/issues/1) workspace tagline + 6-stat table ([2ef99b4](https://github.com/Mourdi59/MD_OCERP/commit/2ef99b4ea276e4281ca173d9acae30b91ff90fa7))
* **readme:** move stats table below the teaser video ([ca7f839](https://github.com/Mourdi59/MD_OCERP/commit/ca7f83932c96acb9ba80162cef6950df387eec45))
* **readme:** one-line stat labels (nbsp) + drop duplicate stats footer ([5063fd4](https://github.com/Mourdi59/MD_OCERP/commit/5063fd4baf33f4c563029a4f652256035ee1251c))
* **readme:** replace all 47 body emojis with GitHub Octicons (light+dark) ([2a767b1](https://github.com/Mourdi59/MD_OCERP/commit/2a767b1e0fcece1127efb0041da533a47ec1030f))
* **readme:** replace legacy 'openestimate' CLI mention with 'openconstructionerp' ([dd6b3a6](https://github.com/Mourdi59/MD_OCERP/commit/dd6b3a67caed458cb56aabd9ed1f26e16dfce1ae))
* **readme:** replace ToC emojis with GitHub Octicons (light+dark variants via picture) ([5f671dc](https://github.com/Mourdi59/MD_OCERP/commit/5f671dce3769e5eee707c0823999d271c01291d8))
* **readme:** WordPress-for-construction tagline + ci(pypi): token fallback ([2f1f2fb](https://github.com/Mourdi59/MD_OCERP/commit/2f1f2fb2a32e03c148b0cc251c5ab145fa5f5a41))
* refresh README hero image (4D-5D + property mgmt highlights, dashboard + BIM viewer + BOQ + DWG + PDF takeoff) ([99807d7](https://github.com/Mourdi59/MD_OCERP/commit/99807d715fb8545e915ade0acf847fc86d91b312))
* refresh README hero image with feature-grid layout ([874e5ad](https://github.com/Mourdi59/MD_OCERP/commit/874e5ade2d50f8dd6ceaa1a9830b4b6ae04970a1))
* v4.5 → v4.6 migration guide ([d756b38](https://github.com/Mourdi59/MD_OCERP/commit/d756b389c90ebbe2ccbd4929d0250ac8d96d941a))


### Tests

* **accommodation:** xfail overlap tests pending source fix re-apply ([18aaddd](https://github.com/Mourdi59/MD_OCERP/commit/18aaddd42b23816aab8e5d664e8c6837559646eb))
* **audit:** backend coverage for Epic H universal audit trail ([c8ac96d](https://github.com/Mourdi59/MD_OCERP/commit/c8ac96de2f5697ef31a0f49ba53042791e5761b7))
* backfill 14 module/security tests + fix v3099_subs revision assertion ([b052d02](https://github.com/Mourdi59/MD_OCERP/commit/b052d02801a14501c93b1005d1ebde050eab4c78))
* **boq:** add 8 backend tests for Epic I (importer protocol, dispatcher, BC3, NRM, MasterFormat, GAEB refactor) ([ae6cb31](https://github.com/Mourdi59/MD_OCERP/commit/ae6cb319cc791c34af17e18f5e351c2c8bb6724a))
* **crm:** restore 5 R7 orphan tests parked by v4.7.2 triage ([bc0f898](https://github.com/Mourdi59/MD_OCERP/commit/bc0f8980d837ca5b7ddaf1b8945f6cf1c1d25772))
* **file-versions:** backend coverage for Epic C wiring + backfill ([6ad5a43](https://github.com/Mourdi59/MD_OCERP/commit/6ad5a4371e1e2bf35a69898c7682624f08065172))
* **geo:** browser-driven /geo diagnostics (DOM chain + click flow + Cesium load) ([c194d8f](https://github.com/Mourdi59/MD_OCERP/commit/c194d8f6830067c56f2d51f413d9c11752451c95))
* **notifications:** Epic B coverage — dispatcher, ws_hub, webhook secret hygiene ([d6b0c9a](https://github.com/Mourdi59/MD_OCERP/commit/d6b0c9ad4c71dc218ad9580f2a19a6e7c5d0ce8e))
* **property_dev:** buyer portal — 10 spec-driven tests (multi-use, cross-scope, audit, IDOR rotation) ([8e88246](https://github.com/Mourdi59/MD_OCERP/commit/8e88246977f24451d4364437f92e60e24d49d4d6))
* **property_dev:** pricing engine — +8 tests (snapshot immutability, RBAC, currency, defensive matchers) ([4f0bd5a](https://github.com/Mourdi59/MD_OCERP/commit/4f0bd5afdccd46647b5318b14940657363694bda))
* **property_dev:** rewrite verify-idempotency test to assert single-use semantics ([197c6b1](https://github.com/Mourdi59/MD_OCERP/commit/197c6b1337fc26079b8c596424a51b52e7a0eb92))
* **property_dev:** tolerate naive datetime on portal expires_at ([9f57817](https://github.com/Mourdi59/MD_OCERP/commit/9f57817a26994cf81a13a5d8981e7159d43d4334))
* **shared:** comprehensive coverage for RequiresProject + RecoveryCard + WideModal + useConfirm + MoneyDisplay + AdminOnly ([66c444a](https://github.com/Mourdi59/MD_OCERP/commit/66c444a99b53052b61ab23de33662b2ff4d0f8e8))


### Miscellaneous

* **ai:** close prior-agent cost-tracking follow-up ([2ebc219](https://github.com/Mourdi59/MD_OCERP/commit/2ebc219373a557cb07130fbbdf28c84178c3e752))
* alembic v3141 for [#161](https://github.com/Mourdi59/MD_OCERP/issues/161) + credit [@rjohny55](https://github.com/rjohny55) in AUTHORS ([115b0b3](https://github.com/Mourdi59/MD_OCERP/commit/115b0b32845ecf1f4d8c4ce0ca06a80e5eb068d3))
* **alembic:** relink Wave 1 migration chain — v3142 → v3143 → v3144 ([4072341](https://github.com/Mourdi59/MD_OCERP/commit/40723410a2e4e0e80bb6d93505f9eff5888d6372))
* **alembic:** replace f-string SQL with bind params (defense-in-depth) ([56ec1fb](https://github.com/Mourdi59/MD_OCERP/commit/56ec1fb89a0b1445ce7bf97ba62bdb8bb6b55e99))
* commit i18n analysis scripts + news-widget QA artefacts ([5dfcb47](https://github.com/Mourdi59/MD_OCERP/commit/5dfcb4705d497bc5e716b84c2151bd142001e743))
* **deps:** actions/dependency-review-action 4 → 5 ([#140](https://github.com/Mourdi59/MD_OCERP/issues/140)) ([9b49dcf](https://github.com/Mourdi59/MD_OCERP/commit/9b49dcfdbc61cccf39a03d444097c245cba409cf))
* **deps:** minor-patch group (3 updates) ([#165](https://github.com/Mourdi59/MD_OCERP/issues/165)) ([0fca684](https://github.com/Mourdi59/MD_OCERP/commit/0fca684d0f835419031291aeb8180aab4538b237))
* **deps:** minor-patch group (8 updates) ([#158](https://github.com/Mourdi59/MD_OCERP/issues/158)) ([2a8561d](https://github.com/Mourdi59/MD_OCERP/commit/2a8561d12e7f5d616756414fdeaa1b07832a87d7))
* **deps:** openssl 0.10.79 → 0.10.80 ([#151](https://github.com/Mourdi59/MD_OCERP/issues/151)) ([5a0720b](https://github.com/Mourdi59/MD_OCERP/commit/5a0720b5c92499ae0bc1861691dcbf95c99f84c2))
* **deps:** pandas &lt;3 → &lt;4 upper bound ([#141](https://github.com/Mourdi59/MD_OCERP/issues/141)) ([deab722](https://github.com/Mourdi59/MD_OCERP/commit/deab722e190ea944371e3800045d9d8d5754ca16))
* **deps:** tmp 0.2.5 → 0.2.6 ([#163](https://github.com/Mourdi59/MD_OCERP/issues/163)) ([4edf7a3](https://github.com/Mourdi59/MD_OCERP/commit/4edf7a37b561d6c11c5f700a3fc432d4e65b2979))
* drop stray test_logo.svg from verification scratch ([6a5b93c](https://github.com/Mourdi59/MD_OCERP/commit/6a5b93c6f726d1f0b7204dc951dc5868b98c7dcf))
* **gitignore:** exclude internal docs secrets, probes, and reingest backups ([abecd5b](https://github.com/Mourdi59/MD_OCERP/commit/abecd5b6f979a73d215e1eaf7ecc0b5012134899))
* **gitignore:** ignore internal docs ([7dc5adc](https://github.com/Mourdi59/MD_OCERP/commit/7dc5adc0f8f322bd6eb7830caf1a0d71c5747c26))
* neutralize internal tooling references in docs and ignore rules ([a3c85b7](https://github.com/Mourdi59/MD_OCERP/commit/a3c85b7d16e956807cafe51c660d217a4566a48a))
* **qa:** full-app route-grid screenshot harness ([95738d0](https://github.com/Mourdi59/MD_OCERP/commit/95738d082c5d0ede07ec4ea7192332af1551cc0c))
* release v4.12.0 ([bec8336](https://github.com/Mourdi59/MD_OCERP/commit/bec83369ca041e2f106637a369f597d0fe885188))
* release v5.0.0 — second stable major ([5e9468f](https://github.com/Mourdi59/MD_OCERP/commit/5e9468f25d8ec25d1e0fd9606d6f99409bc3586d))
* **release:** bump version to 4.7.0 ([4b1b084](https://github.com/Mourdi59/MD_OCERP/commit/4b1b0849a89221aeaf8c440e2dade38410f4b6c4))
* **release:** bump version to 4.7.1 ([c930f37](https://github.com/Mourdi59/MD_OCERP/commit/c930f37a7fdbf36c9d7cf1ff37ab646e74a31a53))
* **security:** tighten JWT secret guard + .env.example doc ([f2cdf7c](https://github.com/Mourdi59/MD_OCERP/commit/f2cdf7c915e47bc09b28ece0cc1e7f0b7d3d1468))
* **showcase:** remove Жилой комплекс «Нева» project from seed snapshot ([40a08ab](https://github.com/Mourdi59/MD_OCERP/commit/40a08ab7d66182ea4be617aae95d39014d278633))
