...
The platform ships 192 modules (projects, costs, boq, users, takeoff, validation, and many more). Each module owns a `router.py`, and the module loader mounts it automatically at:
